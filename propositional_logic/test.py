...
def axiom_generator_percept_sentence(t, tvec):
    ...
    print(axiom_str)
    return axiom_str
#axiom_generator_percept_sentence(t=0, tvec=[False, True, False, False, True])
...
def axiom_generator_initial_location_assertions(x, y):
    ...
    print(axiom_str)
    return axiom_str
#axiom_generator_initial_location_assertions(x=1, y=1)
...
def axiom_generator_pits_and_breezes(x, y, xmin, xmax, ymin, ymax):
    ...
    # return axiom_str
#axiom_generator_pits_and_breezes(x=1, y=1, xmin=0, xmax=5, ymin=0, ymax=5)
...
def axiom_generator_wumpus_and_stench(x, y, xmin, xmax, ymin, ymax):
    ...
    print(axiom_str)
    return axiom_str
#axiom_generator_wumpus_and_stench(x=1, y=1, xmin=0, xmax=5, ymin=0, ymax=5)
